# Django settings for journotools project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'journotools',                      # Or path to database file if using sqlite3.
        'USER': 'postgres',                      # Not used with sqlite3.
        'PASSWORD': 'ricetrac',                  # Not used with sqlite3.
...
SECRET_KEY = '_3+6p=2^(4yx-*990(y-&y7xb0z(lhtd15*-0*m9q^)(p@=r9@'
